...
"""
InfixFunctionInvocation module for Jsonata Python implementation.
Defines the InfixFunctionInvocation class for function call, lambda, and block expression operators in the Jsonata parser.
"""
