...
from jsonata.cython.constants import Constants
...
class DateTimeUtils:
    ...
    def _format_integer(value: int, format: Optional[Format]) -> str:
        ...
        if format.primary == DateTimeUtils.Formats.LETTERS:
            ...
            raise RuntimeError(Constants.ERR_MSG_SEQUENCE_UNSUPPORTED.format(format.token))
        if negative:
        ...
        while pos < len(picture):
            if picture[pos] == '[':
                ...
                if def_.presentation1 is None:
                    raise RuntimeError(Constants.ERR_MSG_UNKNOWN_COMPONENT_SPECIFIER.format(def_.component))
        ...
        if "YMDdFWwXxHhms".find(marker_spec.component) != -1:
            ...
            if marker_spec.names is not None:
                if marker_spec.component == 'M' or marker_spec.component == 'x':
                    ...
                    raise RuntimeError(Constants.ERR_MSG_INVALID_NAME_MODIFIER.format(marker_spec.component))
        ...
        for part in format_spec.parts:
            ...
            if part.type == "literal":
                ...
                if part.component == 'M' or part.component == 'x':
                    ...
                    raise RuntimeError(Constants.ERR_MSG_INVALID_NAME_MODIFIER.format(part.component))
